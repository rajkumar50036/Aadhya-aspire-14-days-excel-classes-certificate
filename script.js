  ...
  if (downloadPdfBtn) {
    downloadPdfBtn.addEventListener('click', () => {
      ...
      const proceedWithPDF = () => {
        try {
          // Native dimensions of the template image (1024x723 for the 14-days template)
          const nativeWidth = 1024;
          const nativeHeight = 723;
          const scale = 3.0; // 3x scale for ultra-sharp rendering of the smaller template size (3072x2169px)
          ...
          // Scale all drawing coordinates by 3x
          ...
          // Font styling: bold 11px Inter, Color: #1a1e26
          ...
          // Font styling: italic 600 30px Playfair Display, Color: #0c1c38
          ...
          const nameY = nativeHeight * 0.510;
          ...
          doc.save(`Aadhya_14_Days_Training_Certificate_${safeName}.pdf`);
